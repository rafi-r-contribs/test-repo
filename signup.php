...
<!--                    User_role-->
                        <div class="user-role-container" style="margin-top: 10px;">
                            <p>ロールを選んでください</p>
                            <form method="" onsubmit="">
                                <label class="radio-inline">
                                    <input type="radio" name="option_student" checked>  生徒
                                </label>
                                <label class="radio-inline ml-5">
                                    <input type="radio" name="option_teacher">  教師
                                </label>
                            </form>
                        </div>

<!--                        input notication medium-->
                        <div class="user-role-container" style="margin-top: 10px;">
                            <p>通知媒体を選んでください</p>
                            <form method="" onsubmit="">
                                <div class="form-group">
